...
public class ResultSetRegressionTest extends BaseTestCase {
	...
	/**
	 * Tests fix for BUG#11190 - ResultSet.moveToCurrentRow() fails to
	 * work when preceeded with .moveToInsertRow().
	 * 
	...
	public void testBug10485() throws Exception {
		...
		assertEquals(newYears2005.toString(), rs.getString(1));
	...
	/**
	 * Tests fix for BUG#11552, wrong values returned from
	 * server-side prepared statements if values are unsigned.
	 * 
	 * @throws Exception if the test fails.
	 */
